...
| PC-08 | 一括取り込みモーダル | Windows | 所有形態と保存先を指定し、ISBN・TSV/TXTを最大200件登録 |
...
- 実本・電子書籍のセグメント、保管場所または電子媒体、複数行入力、TSV/TXT選択、件数、結果を表示する。
- 入力はISBNのみ、`タイトル<TAB>著者`、`ISBN<TAB>タイトル<TAB>著者`を受け付ける。
